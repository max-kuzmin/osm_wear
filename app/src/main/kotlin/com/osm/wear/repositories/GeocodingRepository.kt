...
class GeocodingRepository(
        ...
        try {
            ...
            client.newCall(request).execute().use { response ->
                if (response.isSuccessful) {
                    ...
                    Log.e("GeocodingRepository", "Reverse geocode response unsuccessful: ${response.code}")
                }
            }
        } catch (e: Exception) {
            Log.e("GeocodingRepository", "Failed to reverse geocode: ${e.message}", e)
        }
        ...
        try {
            ...
            client.newCall(request).execute().use { response ->
                if (response.isSuccessful) {
                    ...
                    Log.e("GeocodingRepository", "Search geocode response unsuccessful: ${response.code}")
                }
            }
        } catch (e: Exception) {
            Log.e("GeocodingRepository", "Failed to search address: ${e.message}", e)
        }
    ...
    override suspend fun fetchRoute(
        ...
        try {
            ...
            Log.e("GeocodingRepository", "Failed to fetch OSRM route: ${e.message}", e)
        }
